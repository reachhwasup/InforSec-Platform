...
$playlist = isset($_POST['playlist']) ? htmlspecialchars($_POST['playlist'], ENT_QUOTES, 'UTF-8') : '';

// Sanitize FILE inputs safely
$thumb = isset($_FILES['thumb']['name']) ? $_FILES['thumb']['name'] : '';
$thumb = htmlspecialchars($thumb, ENT_QUOTES, 'UTF-8');
$thumb_ext = pathinfo($thumb, PATHINFO_EXTENSION);
$rename_thumb = unique_id().'.'.$thumb_ext;
$thumb_size = isset($_FILES['thumb']['size']) ? $_FILES['thumb']['size'] : 0;
$thumb_tmp_name = isset($_FILES['thumb']['tmp_name']) ? $_FILES['thumb']['tmp_name'] : '';
...
// File size check & database insertion
